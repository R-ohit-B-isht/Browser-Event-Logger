...
class Background {
  ...
  async stop() {
    ...
    const { base, puppeteer, playwright } = generator.generate(this._recording)
    console.log(puppeteer, playwright,recording)

    storage.set({ recording: this._recording,base:base })
  }
  ...
  handleRecordingMessage({ control, href, value }) {
